...
public class ExternalReaction extends JPanel {
  ...
  public ExternalReaction() {
    setLayout(new BorderLayout());
    DefaultListModel<String> listModel = new DefaultListModel<>();

    //TODO: Add some items to the list
    listModel.addElement("PUSHBACK at point [-2.98081, 0.0, -1.9683] in IN (in BODY frame)");
    listModel.addElement("HOOK at point [100.669, 0.0, -28.818] in IN (in BODY frame)");
