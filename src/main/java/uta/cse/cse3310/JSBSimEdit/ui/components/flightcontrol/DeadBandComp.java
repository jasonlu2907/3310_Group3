...
public class DeadBandComp extends JLabel {
    ...
    public DeadBandComp(Deadband deadband, String file) {
        super(new ImageIcon(file));

        this.deadband = deadband;
        this.description = deadband.getDescription();
        this.input = deadband.getInput();
        this.width = deadband.getWidth();
        this.clipto = deadband.getClipto();
        this.output = deadband.getOutput();
        this.name = deadband.getName();
...
//            repaint();
    ...
    protected JPanel createBasicPane() {
        ...
        String deadB_value = String.valueOf(this.width);
        ...
        save.addActionListener(event -> {
            ...
            this.deadband.setName(name_field.getText());
            ...
            this.deadband.setClipto(this.clipto);

            this.width = Float.parseFloat(deadB_field.getText());
            this.deadband.setWidth(this.width);
